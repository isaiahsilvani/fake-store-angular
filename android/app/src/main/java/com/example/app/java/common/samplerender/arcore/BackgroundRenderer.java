 ...
 */
package com.example.app.java.common.samplerender.arcore;
...
public class BackgroundRenderer {
  ...
  public void drawVirtualScene(
    ...
    Log.e("TEST", "isaiah - draw a virtual scene");
    Log.e("TEST", "Isaiah - get the color");
    occlusionShader.setTexture(
        "u_VirtualSceneColorTexture", virtualSceneFramebuffer.getColorTexture());
    if (useOcclusion) {
      Log.e("TEST", "Isaiah - useOcclusion");
      occlusionShader

...
import com.example.app.java.common.helpers.SnackbarHelper
import com.example.app.java.common.helpers.TapHelper
...
class HelloArView(val activity: HelloArActivity) : DefaultLifecycleObserver {
  ...
  val closeButton = root.findViewById<ImageButton>(R.id.close_ar_button).apply {
    setOnClickListener {
      Log.e("ISAIAH", "Isaiah - I clicked the button!!!")
      this@HelloArView.activity.finish()
    }
  }

 ...
 */
package com.example.app.java.common.samplerender;
    ...
    glSurfaceView.setRenderer(
        new GLSurfaceView.Renderer() {
          ...
          public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            Log.e("TEST", "Isaiah - onSurfaceCreated for SampleREnderer!");
          ...
          public void onSurfaceChanged(GL10 gl, int w, int h) {
            viewportWidth = w;
            viewportHeight = h;
            Log.e("TEST", "Isaiah - onSurfaceChange!");
            Log.i("TEST", "Isaiah - is renderer init??:" + renderer.toString());
